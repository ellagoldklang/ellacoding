...
<head>
  ...
  <title>ella has a question...</title>
...
<body>
  ...
  <main class="card">
    ...
    <h1>may we eat acai bowls for saturday breakfast/brunch?</h1>
    ...
    <!-- HINT -->
    <div class="hint" id="hint">“No” seems super nonchalant</div>

    <section class="result" id="result">
      <h2>Yay good boy! ❤️</h2>
      <img
        class="fireworks"
        src="https://media0.giphy.com/media/v1.Y2lkPTc5MGI3NjExeXBodmV4ZDYweXNtc2dsN2s2dGQ3amhpYXQzeGR2Z3lseG9xN2dvNiZlcD12MV9pbnRlcm5hbF9naWZfYnlfaWQmY3Q9Zw/z2kAvqqVS9lAT1ZEY2/giphy.gif"
        alt="Fireworks"
      />
    </section>
  </main>
